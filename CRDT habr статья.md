...
В отличие от чисел, тут важен не только набор элементов, но и их порядок.  Индексы быстро становятся ненадёжными: если кто-то вставил или удалил символ до вашей позиции, ваш индекс уже не соответствует ожидаемому месту. 
