...
В отличие от чисел, где достаточно просто складывать значения, в тексте важен порядок символов и операций.  Индексы быстро становятся ненадёжными: если кто-то вставил или удалил символ до вашей позиции, ваш индекс уже не соответствует ожидаемому месту. 
Будем показывать на примере  RGA: Replicated Growable Array
