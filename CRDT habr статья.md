...
После мержа каждый массив next будет отсортирован всегда в одинаковом порядке. Это гарантирует нам что мы всегда знаем в какую ветку спустится сначала. Получение текста из структуры можно представить как обычный пребор графа в глубину 
